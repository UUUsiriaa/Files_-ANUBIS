...
if DevSIRI:get(ANUBIS.."SIRI:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevSIRI:sadd(ANUBIS.."SIRI:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevSIRI:get(ANUBIS.."SIRI:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
ANUBISName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if ANUBISName then 
ANUBISNames = DevSIRI:smembers(ANUBIS.."SIRI:Mute:Names"..msg.chat_id_) or ""
...
DevSIRI:set(ANUBIS.."SIRI:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevSIRI:del(ANUBIS.."SIRI:Lock:MuteNames"..msg.chat_id_)
end
end
end
